...
export CHATQNA_HUGGINGFACEHUB_API_TOKEN="" # Replace with your actual HF token
...
export CHATQNA_FRONTEND_SERVICE_PORT=5174
export CHATQNA_NGINX_PORT=8081
export CHATQNA_REDIS_DATAPREP_PORT=18104
export CHATQNA_REDIS_RETRIEVER_PORT=7001
export CHATQNA_REDIS_VECTOR_INSIGHT_PORT=8002
export CHATQNA_REDIS_VECTOR_PORT=6380
export CHATQNA_TEI_EMBEDDING_PORT=18091
export CHATQNA_TEI_RERANKING_PORT=18809
...
export LLM_SERVER_HOST_IP=chatqna-vllm-service
export LLM_SERVER_PORT=8011  # Internal port (NOT 18008)
